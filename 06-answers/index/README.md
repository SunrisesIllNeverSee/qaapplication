# 06-answers/index — Rolling Answer Bank (TOC)
...
- `AP-cyberfund` — application identity (matches the slug used across
  `03-programs/`, `04-applications/`, `08-submitted/archived_applications/`)
...
- Filled record: `../../08-submitted/archived_applications/<slug>.md`
- Paired Q+A: `../../08-submitted/archive/<slug>.md`
